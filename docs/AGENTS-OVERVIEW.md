...
Two jobs, in this order: **reconcile the threads, then chase the silence.** Reply classification and drafting belong to the webhook, not here. Reconcile failure only degrades the run to `partial`.
